const ownerNumber = ["557388843631@s.whatsapp.net","559288234653@s.whatsapp.net","554197660989@s.whatsapp.net"]
...
const antinewchatmsg = '🚫 PV BLOQUEADO 🚫'
...
let mess = {
    wait: '「 *AGUARDE* 」 ACEITA UM PEDAÇO DE BOLO?🍰',
    success: '「 *AGUARDE* 」 ',
    error: {
